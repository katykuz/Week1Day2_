...
public class CellPhoneTest
{
   public static void main(String[] args)
   {
      ...
      //Get provider
      System.out.print("Enter provider of phone: ");
      testProvider = keyboard.nextLine();

      // Create an instance of the CellPhone class,
      // passing the data that was entered as arguments
      // to the constructor.
      CellPhone phone = new CellPhone(testMan, testMod, testPrice, testColor, testProvider);
      ...
      System.out.println("Provider: " + phone.getProvider());
   }
}